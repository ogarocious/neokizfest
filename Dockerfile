...
# docker build -t neokizfest .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name neokizfest neokizfest
...
# Install base packages (no postgresql - using Notion for data)
