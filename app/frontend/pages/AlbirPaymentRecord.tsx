...
const TIMELINE: TimelineEvent[] = [
  ...
  },
  {
    ...
    imageCaption:
      "NeoKiz Facebook post promoting Albir Rojas podcast, August 5, 2022",
    highlight: "positive",
  ...
  },
  {
    ...
    imageCaption:
      "WhatsApp — Charles forwards internal accounting emails to Albir, Aug 17, 2022",
    highlight: "positive",
  ...
  },
  {
    ...
    imageCaption:
      "In loving memory of Fidelis Ogar, February 10, 1959 – October 12, 2022",
    highlight: "neutral",
  ...
  },
  {
    ...
    imageCaption:
      "WhatsApp — Charles shares his father's passing, Nov 11, 2022",
    highlight: "neutral",
  ...
  },
  {
    date: "July 3, 2023",
    title:
      "Charles Documents Lucas's Behavior in Writing to DJ Art's Management",
    description:
    ...
    emailExhibit: {
      ...
      subject:
        "Summary of Neokiz 2022 Interactions and Future Engagement Considerations",
      points: [
  ...
  },
  {
    date: "September 17, 2023",
    title:
      'Charles Replies: "Getting in Communication With You Is Not the Easiest Task"',
    description:
    ...
    imageCaption:
      "WhatsApp — Charles's reply forwarding prior outreach, Sep 17, 2023",
    highlight: "neutral",
  ...
  },
  {
    ...
    imageCaption:
      "WhatsApp — Albir acknowledges his communication problems, Sep 17, 2023",
    highlight: "neutral",
  ...
  },
  {
    ...
    imageCaption:
      "WhatsApp — Charles asks directly for payment info, Sep 18, 2023",
    highlight: "neutral",
  ...
  },
  {
    ...
    imageCaption:
      "WhatsApp — Charles's three unanswered scheduling attempts, Feb 25–Mar 11, 2026",
    highlight: "negative",
...
const EvidenceSlot: React.FC<EvidenceSlotProps> = ({
  filename,
  caption,
  src,
}) => {
  ...
  return (
    <>
      <Head title="NeoKiz 2022 Payment Record — Charles Ogar">
        ...
        <meta
          property="og:title"
          content="NeoKiz 2022 Payment Record — Charles Ogar"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="/images/case/og-albir-payment-record.png"
        />
          ...
          <Box px={{ base: "sm", sm: "md" }}>
            <GlassCard variant="accent" p={0} style={{ overflow: "hidden" }}>
              ...
              <Stack gap="xs" p={{ base: "md", sm: "xl" }}>
                ...
                >
                  Albir Rojas was not just another booking. Charles was once
                  Albir's student — one private lesson and years of festival
                  classes in San Antonio, Texas between 2014 and 2017. Albir
                  introduced Charles to what we now call urbankiz. When Charles
                  became an organizer, he invited Albir to NeoKiz 2018 — a
                  booking that fell through because a representative
                  intentionally withheld flight information. Charles gave the
                  benefit of the doubt and booked Albir directly for NeoKiz 2022
                  anyway, based on their personal relationship. This is the
                  context the public accusations leave out.
                </Text>
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.small, lineHeight: 1.75 }}
                >
                  The payment for NeoKiz 2022 was made in full — €1,440.30 to
                  Albir Rojas via PayPal in June 2024. The delay was not
                  avoidance. It was a direct result of Albir failing to provide
                  payment details for nearly 20 months. This is the documented
                  record, in sequence, with evidence.
                </Text>
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.small, lineHeight: 1.75 }}
                >
                  This case is one in a series. Multiple artists have made
                  public claims of non-payment against NeoKiz — none with
                  supporting documentation. In response, every festival edition
                  is being reviewed and every artist payment is being documented
                  with receipts. Two additional case files are currently in
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.small, lineHeight: 1.75 }}
                >
                  For context on who is making these claims: as of March 2026,
                  NeoKizFest is 75% through a fully public, documented refund
                  process — one that has returned money to over 140 ticket
                  holders with receipts, confirmations, and a live progress
                  dashboard. That system exists because accountability matters.
                  These records exist for the same reason.
                </Text>
                  ...
                  <Table.Tbody>
                    {(
                      [
                        ...
                        [
                          "Known Since",
                          "2014 — Charles was Albir's student, San Antonio, TX",
                        ],
                        ["Total Paid", "€1,440.30"],
                        [
                          "Payment 1",
                        ...
                        [
                          "Time to Receive Payment Info",
                          "~20 months after the festival",
                        ],
                      ] as [string, string][]
                    ).map(([label, value]) => (
                      <Table.Tr key={label}>
                  ...
                  {TIMELINE.map((event, i) => {
                    ...
                    return (
                      <React.Fragment key={i}>
                        ...
                        {event.gapAfterMonths && (
                          <TimelineGap months={event.gapAfterMonths} />
                        )}
                      </React.Fragment>
                    );
                  })}
              ...
              <Stack gap="md">
                <Stack gap={4}>
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small }}
                  >
                    Albir provided a detailed rate sheet before the festival. It
                    listed every price. It did not include any payment
                    information.
                  </Text>
                </Stack>
              ...
              <Stack gap="lg">
                <Stack gap="xs">
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small }}
                  >
                    These are honest questions that deserve honest answers. This
                    is a direct, man-to-man address to Albir Rojas. These
                    questions were raised privately in February 2026 before this
                    page existed. No answers were given. Charles will not engage
                    with Lucas — these are directed at Albir alone.
                  </Text>
                </Stack>
                ...
                <Stack gap={6}>
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small, lineHeight: 1.75 }}
                  >
                    These questions were sent to Albir privately in February
                    2026, before this page was published. No answers were given.
                    This record will remain public until they are.
                  </Text>
                  <Text
                    c={colors.textDim}
            ...
            <GlassCard variant="subtle" p={{ base: "md", sm: "xl" }}>
              <Stack gap="lg">
                ...
                <Stack gap="md">
                  ...
                  >
                    I am not trying to cancel Albir Rojas. I have no interest in
                    ending Albir's career or damaging Albir's reputation beyond
                    what the facts already say. What I want is simple: for Albir
                    to set the record straight. A single post. A single
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small, lineHeight: 1.8 }}
                  >
                    I went public because Lucas Nuance went public first — with
                    a document that named me alongside people accused of sexual
                    assault and fraud. That accusation was made in front of the
                    entire kizomba community. I contacted Albir privately in
                    February 2026, before publishing anything, and gave him
                    every opportunity to address it without this page ever
                    needing to exist. Albir suggested a call. Then went silent
                    for three weeks across three follow-up messages. At some
                    point, silence is its own answer.
                  </Text>
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small, lineHeight: 1.8 }}
                  >
                    There is a word for what Albir's silence has been since June
                    2024 — since the moment he was paid in full and the debt was
                    closed. It is not absence. It is not a communication
                    problem.{" "}
                    <Text span fw={700} style={underlineAccent}>
                      It is tacit authorization.
                    </Text>{" "}
                    In practice, choosing not to stop something you are aware of
                    is the same as allowing it. Albir has not posted that I paid
                    him. Albir has not publicly distanced himself from the
                    Dance-Stein Files or from what Lucas published in his name.
                    Every day that passes without a correction is another day
                    the false claim stands by default — with Albir's silence as
                    its foundation. That is not oversight.{" "}
                    <Text span fw={700} style={underlineAccent}>
                      That is a choice.
                    </Text>
                  </Text>
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small, lineHeight: 1.8 }}
                  >
                    Honestly — I held my tongue too long. I absorbed the
                    auto-replies, the delayed PayPal info, the Lucas DM, the
                    Dance-Stein document, and kept trying to handle it
                    privately. I stayed quiet while the narrative spread. That
                    was a mistake. The truth had a right to be documented from
                    the moment the first false claim was made. This page is the
                    correction that should have existed sooner.
                  </Text>
                  ...
                  >
                    <Text span fs="italic">
                      I want to be honest about something that is harder to say
                      than any of the facts above: I am embarrassed.
                    </Text>{" "}
                    Not about what I did — the receipts speak for themselves. I
                    am embarrassed that this is the reality of the kizomba scene
                    I have spent years trying to build and represent. I have
                    been an ambassador of this dance. I traveled, I organized, I
                    invested, and I believed the community was worth it.
                    Situations like this are exactly what drive people away —
                    the ones already here, and the ones who might have joined
                    us. This kind of drama does not just damage one person. It
                    damages what we are all trying to build. I did not want to
                    post this publicly. I was reluctant, and part of me still
                    is. But there comes a point where silence is not humility —
                    it is complicity. I had to draw a line somewhere. This page
                    is where I drew it.
                  </Text>
                </Stack>
              </Stack>
              ...
              <Stack gap="lg">
                <Stack gap={4}>
                  ...
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small }}
                  >
                    The following is drawn entirely from documented interactions
                    in this record. No claims are made beyond what is evidenced
                    above.
                  </Text>
                </Stack>
                ...
                <Stack gap="md">
                  <Text
                    ...
                    style={{ fontSize: responsiveText.small, lineHeight: 1.8 }}
                  >
                    What is documented in this record has a name. Inserting
                    himself into situations without authorization. Being
                    belligerent with staff who had less perceived power,
                    congenial with those who had more. Using implied pressure —
                    "this doesn't have to be as public as it already has been" —
                    as a tool to coerce payment. Publishing false claims to
                    damage someone's reputation. Continuing that campaign 19
                    months after the underlying dispute was fully resolved. That
                    is not a misunderstanding. That is not a communication
                    problem.{" "}
                    <Text span fw={700} style={underlineAccent}>
                      That is bullying
                    </Text>{" "}
                    — a sustained pattern of intimidation and reputational harm
                    directed at someone perceived as a target.
                  </Text>
                  ...
                  >
                    <strong style={{ color: "rgba(255,255,255,0.85)" }}>
                      If you are an artist working with Lucas as your manager or
                      booking agent:
                    </strong>{" "}
                    This record documents Lucas inserting himself into a payment
                    dispute between me and Albir — despite attending NeoKiz 2022
                    solely as DJ Art's representative, with no documented role
                    in Albir's booking. He contacted an organizer claiming money
                    was owed before any payment had been made. When the
                    Dance-Stein Files were published, the debt he cited had
                    already been settled in full for 19 months. What he says in
                    your name, and what he publishes under your name, becomes
                    part of your public record too. You should know what that
                    is.
                  </Text>
                  ...
                  >
                    <strong style={{ color: "rgba(255,255,255,0.85)" }}>
                      If you are an organizer who has booked or is considering
                      booking an artist through Lucas:
                    </strong>{" "}
                    The July 2023 letter documented in this record describes his
                    conduct at NeoKiz 2022 — requesting credentials not covered
                    by the contract, discrepant communications with different
                    staff members about the same situation, and feedback from
                    attendees about interference with DJs. After that festival,
                    he contacted me with the line "this doesn't have to be as
                    public as it already has been." Document everything directly
                    with the artist. Do not rely on an intermediary's account of
                    what was agreed to.
                  </Text>
                  ...
                  >
                    <strong style={{ color: "rgba(255,255,255,0.85)" }}>
                      If you are considering buying a pass to an event Lucas is
                      affiliated with:
                    </strong>{" "}
                    The Dance-Stein Files were published 19 months after I had
                    paid Albir in full — grouping my name alongside people
                    accused of sexual assault and large-scale fraud, based on a
                    debt that no longer existed. That is the standard of
                    accuracy being applied to public claims made in this
                    community. Factor that into what you trust, and who you
                    trust it from.
                  </Text>
                  ...
                  >
                    ...
                    Before this record existed, someone working with Lucas could
                    claim they didn't know. That defense no longer applies.
                    Anyone who now chooses to publicly affiliate with Lucas —
                    lending him their name, their platform, their audience — is
                    doing so with full knowledge of what is documented here.{" "}
                    <Text span fw={700} style={underlineAccent}>
                      A name is an endorsement. An endorsement is a choice.
                    </Text>{" "}
                    And that choice, made knowingly, carries its own
                    accountability.
                  </Text>
                  ...
                  >
                    ...
                    would not be surprising if this pattern has touched other
                    people in this scene — organizers or artists who ran into
                    similar dynamics and didn't have the receipts, the platform,
                    or the energy to document it publicly. The kizomba community
                    is already a small, fragile world. It does not need this
                    kind of unnecessary friction making it smaller. This record
                    is part of an effort to grow the scene honestly — and that
                    starts with the community being able to see clearly what is
                    happening within it.
                  </Text>
                  ...
                  >
                    ...
                    This situation is a reminder that disputes can surface years
                    after the fact — with or without Lucas involved. Keep your
                    receipts. Keep your messages. Keep a paper trail of every
                    payment sent and received, every agreement made, and every
                    attempt to communicate. Not because you expect bad faith —
                    but because memory fades, narratives shift, and the only
                    thing that holds up years later is documentation. This
                    record exists because I kept mine. Yours should too.
                  </Text>
                  ...
                  >
                    And there is a broader question this community deserves to
                    sit with:{" "}
                    <Text span fw={700} style={underlineAccent}>
                      why are we accepting this?
                    </Text>{" "}
                    A pattern this clear — spanning multiple years, multiple
                    incidents, multiple people — does not go unnoticed.{" "}
                    <Text span fw={700}>
                      Scenes are shaped by what they tolerate.
                    </Text>{" "}
                    If we want a kizomba community that is worth growing, worth
                    inviting people into, worth defending — we have to be
                    willing to name what is happening inside it, and decide
                    together that we are not okay with it.
                  </Text>
                </Stack>
              </Stack>
            </GlassCard>
              ...
              <Stack gap="lg">
                <Stack gap={4}>
                  ...
                  >
                    ...
                    — a separate public document published on this site about
                    the end of NeoKizFest. It was written independently of this
                    case file.
                  </Text>
                </Stack>
                ...
                <Stack gap="md">
                  ...
                  >
                    ...
                    >
                      "I paid 100% of my artists. Some payments were late
                      because the festival didn't generate enough to cover
                      everything immediately, not because I was pocketing
                      money."
                    </Text>
                    <Text
                      mt={6}
                  ...
                  >
                    ...
                    >
                      "I've dealt with international artists who used
                      intimidation, blackmail, and false claims to try to damage
                      my reputation when things didn't go exactly their way.
                      Artists who benefited from being flown in, housed, fed,
                      and paid, and then turned around and threatened to trash
                      the event privately and publicly if their demands weren't
                      met. That's not professionalism. It's bullying."
                    </Text>
                    <Text
                      mt={6}
                      style={{
                  ...
                  >
                    ...
                    >
                      "My father passed in 2022, which compounded the financial
                      strain on everything that followed."
                    </Text>
                    <Text
                      mt={6}
                      style={{
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.xs, lineHeight: 1.65 }}
                >
                  These statements were published separately and predate this
                  case file. They are included here because they speak directly
                  to the pattern being documented.
                </Text>
              </Stack>
            </GlassCard>
            ...
            <GlassCard variant="subtle" p={{ base: "md", sm: "xl" }}>
              <Stack gap="md">
                ...
                >
                  ...
                  >
                    "I have chased artists down to pay them money sometimes — so
                    it's really crazy. Here at WhereCanWeDance.com we are
                    introducing artist booking portals to help streamline that
                    information."
                  </Text>
                  <Text
                    mt={6}
                ...
                >
                  ...
                  , I built an artist booking portal that captures bios, promo
                  materials, travel preferences, and — critically — payment
                  information, all in one place before any booking is finalized.
                  Artists fill it out once. Organizers have everything they need
                  to pay, promote, and book without chasing anyone down. This
                  situation — 20 months spent trying to obtain a single PayPal
                  address — cannot happen on that platform.
                </Text>
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.small, lineHeight: 1.75 }}
                >
                  I built this for myself. And I built it for every other
                  organizer in the dance community who has ever had to track
                  down a bank account number, a PayPal address, or a promo photo
                  three days before a festival. The problem is industry-wide.
            ...
            <GlassCard variant="subtle" p={{ base: "md", sm: "xl" }}>
              <Stack gap="md">
                ...
                <Text
                  ...
                  style={{ fontSize: responsiveText.small, lineHeight: 1.8 }}
                >
                  I ran NeoKiz for a decade. I built something real in this
                  community. This page exists because the truth deserves a
                  permanent address. My records are open. My door is still open.
                  The documentation above speaks for itself.
                </Text>
            ...
            >
              <Stack gap="md">
                <Text
                  ...
                  style={{ fontSize: responsiveText.small }}
                >
                  If you know people in the kizomba community who have seen
                  false claims about this situation, share this page with them.
                </Text>
                <ArticleMeta
                  author="Charles Ogar"
                  date="March 27, 2026"
